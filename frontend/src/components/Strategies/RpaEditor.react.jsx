/**
 * 文件注释：frontend/src/components/Strategies/RpaEditor.react.jsx
 *
...
// ... 这里往下应该是你的 const initialNodes = [...] 或组件定义
...
const PLATFORMS = [
  ...
  },
  {
    ...
    items: [{ type: 'login_yt', label: '🔑 登录账号' }, { type: 'watch_video', label: '👀 观看视频' }, { type: 'sub_channel', label: '🔔 订阅频道' }]
  },
  {
